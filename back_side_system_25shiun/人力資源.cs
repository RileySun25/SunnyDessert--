...
{
    public partial class 人力資源 : Form
    {
        public 人力資源()
        {
            InitializeComponent();
        ...
        private void 人力資源_Load(object sender, EventArgs e)
        {
        ...
        private void btn產品資訊維護_Click(object sender, EventArgs e)
        {
        ...
        private void btn會員資訊維護_Click(object sender, EventArgs e)
        {
            會員資訊 news = new 會員資訊();
            news.ShowDialog();
        }

        private void btn品牌消息維護_Click(object sender, EventArgs e)
        {
            品牌資訊 news = new 品牌資訊();
            news.ShowDialog();
        }

        private void btn訂單資訊維護_Click(object sender, EventArgs e)
        {
            訂單資訊 news = new 訂單資訊();
            news.ShowDialog();
        }
